...
namespace Figury
{
    public class Trojkat : Wielobok
    {
        ...
        public Trojkat(string nazwa, Punkt[] wierzcholki) : base(nazwa, 3)
        {
            for(int i = 0; i < 3; i++)
            {
        ...
        {
            return string.Format("Trójkąt \"{0}\" o wierzchołkach w " + "punktach: A = {1}, B = {2}, C = {3}", Nazwa, this[0], this[1], this[2]); 
        }
